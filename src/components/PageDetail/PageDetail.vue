...
import VideoPlayerButton from "./VideoPlayerButton.vue"
...
<template>
    ...
    >
        ...
        >
            <h3 class="stroked mr-[12px]">{{ page.getDetailTitleStroked(i18n.getLocale()) }}</h3>
            <h3 class="mr-[30px]">{{ page.getDetailTitleNormal(i18n.getLocale()) }}</h3>
            <VideoPlayerButton
