    ...
    <div 
        ...
        ">
            <transition name="icons" mode="out-in">
                ...
                class="w-[26px] h-[15px] fill-current dark:fill-white transition-colors duration-1000" 
                viewBox="0 0 26 17" 
