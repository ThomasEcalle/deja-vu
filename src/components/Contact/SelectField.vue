...
<template>
    <div class="sm:text-[2vh] text-[1.2vh] transition-colors duration-1000">
        ...
        <div class="relative">
            <select
                class="contact-input transition-colors duration-1000 block w-full sm:h-[6vh] h-[5vh] leading-tight mt-[0.8vh] cursor-pointer appearance-none bg-transparent border border-current py-2 px-3 rounded-md focus:outline-none"
